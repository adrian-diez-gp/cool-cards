...
export default function Specialsheet() {
    ...
    return (
        <div className="colour-page-wrapper">
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/bitterblossomf.jpg"/>
                <p><strong>Rating: A+</strong>. What's better than a faerie? A faerie a turn! This wins.</p>
                <br />
            </div>  
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/defenseoftheheartf.jpg"/>
                <p><strong>Rating: A</strong>. Play a normal game, drop this, and go find your two best Tocinos. Sure win!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/rhysticstudyf.jpg"/>
                <p><strong>Rating: A-</strong>. This will pay for the draft. So, let's win something!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/doublingseasonf.jpg"/>
                <p><strong>Rating: A-</strong>. This will pay for the draft. So, let's win something!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/smotheringtithef.jpg"/>
                <p><strong>Rating: A-</strong>. This will pay for the draft. So, let's win something!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/blindobedience.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/hatchingplans.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/utopiasprawlf.jpg"/>
