...
export default function White() {
    ...
    return (
        <div className="colour-page-wrapper">
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/expeltheinterlopersf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/atalefortheagesf.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/archonofthewildrosef.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/virtueofloyalty.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/theprincesstakesflight.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/pollenshieldhare.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/heartflameduelistf.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/regalbunnicornf.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/werefoxbodyguardf.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/threeblindmicef.jpg" />
                <p><strong>Rating: B-</strong>.  A payoff for all those token cards! It's rare so you probably won't see it though.</p>
                <br />
            </div>
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/shroudedshepherd.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/hopefulvigil.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/spellbookvendorf.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/coopedup.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/woodlandacolyte.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/saviorofthesleeping.jpg" />
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/slumberingkeepguard.jpg" />
