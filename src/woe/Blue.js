...
export default function Blue() {
    ...
    return (
        <div className="colour-page-wrapper">
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/ingeniousprodigyf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/hornedlochwhalef.jpg"/>
                <p><strong>Rating: A</strong>. Strong in the early game (adventure), strong in the late game. Classic bomb!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/talionsmessengerf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/twiningtwinsf.jpg"/>
                <p><strong>Rating: A-</strong>. You don't need white for this card to be ridiculous. If you do, all the more power for you.</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/sleepcursedfaerief.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/extraordinaryjourneyf.jpg"/>
                <p><strong>Rating: B-</strong>. Sideboard card for big creatures. Triggers on adventures, so put this in if you see a lot!</p>
                <br />
            </div>    
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/archivedragon.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/bitterchillf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/gadwicksfirstduelf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://https://mythicspoiler.com/woe/cards/frolickingfamiliarf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/threadbindcliquef.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/succumbtothecold.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/icewroughtsentryf.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/tenacioustomeseeker.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/obyrasattendants.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/splashyspellcaster.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/galvanicgiant.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/quickstudy.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/snaremasterspritef.jpg"/>
            ...
            <div>
                <img className='card-wrapper' src="https://mythicspoiler.com/woe/cards/spellstutterf.jpg"/>
