...
export default function Black() {
    ...
    return (
        <div className="colour-page-wrapper">
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/beseechthemirrorf.jpg"/>
                <p><strong>Rating: A+</strong>. The money pick. You want your draft to be free? You pick this!</p>
                <br />
            </div> 
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/devouringsugarmawf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/gumdroppoisonerf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/specterofmortalityf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/cruelsomnophage.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/lordskittersewerkingf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/lordskittersblessingf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/backforsecondsf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/ashioksreaperf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/faeriefencingf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/egodrainf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/highfaenegotiator.jpg"/>
                <p><strong>Rating: C-</strong>. Strong swing, but only take it if you don't have a good way to finish the game.</p>
                <br />
            </div> 
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/hopelessnightmaref.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/takenbynightmares.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/feedthecauldron.jpg"/>
                <p><strong>Rating: C-</strong>. Cheaper removal, but gives you bargain fodder. Not too bad!.</p>
                <br />
            </div>
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/candygrapple.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/lordskittersbutcherf.jpg"/>
                <p><strong>Rating: C+</strong>. I'm all for creatures that are good at any moment of the game.</p>
                <br />
            </div>
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/voraciousvermin.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/warehousetabbyf.jpg"/>
            ...
            <div>
                <img style={{display:"block"}} src="https://mythicspoiler.com/woe/cards/twistedsewerwitch.jpg"/>
