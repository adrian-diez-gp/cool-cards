...
export default function white() {
    ...
    return (
        <div className="colour-page-wrapper">
            ...
            <img src="https://mythicspoiler.com/woe/cards/nightofthesweetsrevengef.jpg" />
            <img src="https://mythicspoiler.com/woe/cards/welcometosweettoothf.jpg" />

            <h1>RARES AND MYTHICS</h1>
            <img src="https://mythicspoiler.com/woe/cards/grufftripletsf.jpg" />
            <img src="https://mythicspoiler.com/woe/cards/elvisharchivistf.jpg" />
            <img src="https://mythicspoiler.com/woe/cards/mosswooddreadknightf.jpg" />
        </div>
    )
}